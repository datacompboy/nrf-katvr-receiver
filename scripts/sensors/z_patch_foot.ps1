...
$Input | ForEach-Object {
  ...
  if ($in_line -eq  2465) {
    Write-Output ':2029E800542D520512089F000900020A039F1902AF9607B039043D4FF703636505771064F5'
  }
  if ($in_line -eq  2465) {
  ...
  if ($in_line -eq  2497) {
    Write-Output ':162E100014BF4C20522011F17402907140F208301021F0F70BBC39'
  }
  if ($in_line -eq  2497) {
